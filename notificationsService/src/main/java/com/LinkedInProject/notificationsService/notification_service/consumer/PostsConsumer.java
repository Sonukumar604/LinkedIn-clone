...
import com.LinkedInProject.notificationsService.notification_service.repository.NotificationRepository;
...
public class PostsConsumer {
    ...
    public void handlePostCreated(PostCreated postCreated) {
        ...
        String message = String.format("Your connection with id: %d has created this post: %d",
    ...
    public void handlePostLiked(PostLiked postLiked) {
        ...
        String message = String.format("Your connection with id: %d has liked this post: %d",
